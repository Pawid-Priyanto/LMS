<template>
  <div>
    <!-- Dekstop -->
    <b-container class="justify-content-md-center mt-10 category">
        ...
        <b-row>
          <b-col>
            <b-card-group deck class="category-card">
              ...
              <b-card title="Doughnut" img-src="../assets/images/recipes/category/doughnut.png" img-alt="Image" class="donat" img-top>
                <b-card-text>
                  11 items
                </b-card-text>
              </b-card>
